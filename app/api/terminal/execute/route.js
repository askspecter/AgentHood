...
import { CURVE_ABI, resolveLaunch, resolvePonsPool, phaseBlockedMessage, buildV4Swap, v2Config, UNIVERSAL_ROUTER_ABI, PERMIT2_ABI } from "@/lib/engine/ponsV2";
...
export async function POST(request) {
  ...
  try {
    ...
    if (launch) {
      // ---- Graduated / Pons v4: trade the Uniswap v4 pool via the Universal Router ----
      if (launch.phase === 2) {
