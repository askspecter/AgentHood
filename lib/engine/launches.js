...
const BUILTIN_HIDDEN = [
  ...
  // The Bankr $ESKA, superseded by the pools.trade relaunch. Hidden so both
  // don't show side by side; the official pin now points at the new address.
  "0x8e7d62f76df1ffc369ab90967c92d7d68009dba3",
];
