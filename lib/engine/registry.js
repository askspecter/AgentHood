 ...
 */
/**
 * The pinned official token — $ESKA, the site's own coin. Pinned to the top of
 * "launched here" and marked official so the UI can give it the gold verified
 * check. Override any field with OFFICIAL_* env, or set OFFICIAL_TOKEN="" to
 * unpin entirely.
 */
const DEFAULT_OFFICIAL = {
  token: "0x0eB9960654d3661D551a4536D7d425184eC81756",
  symbol: "ESKA",
  name: "ESKA",
  x: "eskafun",
};
