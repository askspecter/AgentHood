...
/**
 * AURN activity stats - trade volume and referrals, for the leaderboards.
 *
 ...
 * start (fine for a demo, not for production). Both boards rank real, AURN-native
...
const VOL_KEY = (network) => `aurn:vol:${network}`;
...
const REF_BOARD = "aurn:ref:board";
const REF_SEEN = "aurn:ref:seen";
