  ...
  return (
    <div className="max-w-2xl mx-auto pb-10">
      ...
      <p className="text-[11px] text-[var(--color-ink-faint)] leading-relaxed mt-4 px-1">
        This document is provided for transparency about how ESKA works and is written in plain language. It is not legal advice. For questions, reach us at <a className="text-[var(--color-accent)] hover:underline" href="mailto:contact@eska.fun">contact@eska.fun</a>.
      </p>
    </div>
  )
}
