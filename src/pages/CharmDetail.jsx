        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {charm.online && <span className="chip !py-0.5 text-[11px]">● online</span>}
                </div>
                <p className="text-[var(--color-ink-soft)] mt-1">{charm.tagline}</p>
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {charm.vibe.map((v) => <span key={v} className="chip !py-0.5 !px-2.5 text-[11px]">#{v}</span>)}
                </div>
              </div>
            </div>
          ...
          <div className="card p-6">
            <div className="flex items-end justify-between mb-4">
              <div>
                <div className="text-xs font-semibold text-[var(--color-ink-soft)] uppercase tracking-wide">Price</div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-[rgba(20,32,59,.08)] text-center">
          ...
          {/* lore */}
          <div className="card p-6">
            <h2 className="font-serif text-2xl mb-2">The lore</h2>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-[var(--color-ink-soft)]">
              ...
              <span className="chip">@{charm.creator}</span>
              <span>·</span>
