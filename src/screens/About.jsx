  ...
  return (
    ...
    >
      <Sec n={1} title="What AURN is">
        ...
        <p>Through AURN you can discover coins, chat with them, view live market data, launch your own coin, swap coins that live in public liquidity pools, and lock supply on-chain for a fixed term - all with your own self-custodial wallet, so your keys and your funds stay entirely in your hands.</p>
      </Sec>
      ...
      <Sec n={3} title="How it works">
        <UL items={[
          ...
          'Lock supply. Time-lock tokens you hold in the AurnLocker contract, and let anyone verify the locks on-chain.',
          'Own it. Coins you launch or buy are real tokens in your wallet, and creators can claim their fees.',
        ]} />
      </Sec>

      <Sec n={4} title="Locking supply">
        <p>AURN includes an on-chain token lock. From Settings, you pick a token you hold on Robinhood Chain and lock a chosen amount for a fixed term. The tokens move into the AurnLocker smart contract, and only you can withdraw them, only after the term ends. It is non-custodial: AURN never holds your keys, and the contract, not us, enforces the lock.</p>
        <p>The list of locked tokens is public. Anyone can open the Locked page and see which tokens are locked, how much, by which wallet, and when each lock unlocks, without connecting a wallet at all. This lets a project prove its own supply is locked and lets buyers verify it for themselves, straight from the chain.</p>
      </Sec>

      <Sec n={5} title="Official channels">
      ...
      <Sec n={6} title="Safety & transparency">
